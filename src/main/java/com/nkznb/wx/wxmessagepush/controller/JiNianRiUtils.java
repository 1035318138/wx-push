...
public class JiNianRiUtils {
    ...
    public static int getLianAi(){
        return calculationLianAi("2016-09-27");
    }
    public static int getBirthday_Zhang(){
        try {
            return calculationBirthday("1999-09-27");
    ...
    public static int getBirthday_Ru(){
        try {
            return calculationBirthday("1998-02-18");
        } catch (ParseException e) {
            e.printStackTrace();
        }
        return 0;
